    ...
    <div class="row-fluid">
      <div class="span6 pay-template-content-form1">
        <div class="panel panel-default">
          ...
          <div class="panel-body">
            <h3><i class="fa fa-user"></i>&nbsp&nbsp<b><?php print t('Name');?>:</b>&nbsp<?php print $offer['name'] ?></h3>
            <h3><i class="fa fa fa-envelope"></i>&nbsp<b><?php print t('E-mail');?>:</b>&nbsp<?php print $offer['email'] ?></h3>
            <h3>&nbsp<i class="fa fa-mobile"></i>&nbsp&nbsp<b><?php print t('Phone');?>:</b>&nbsp<?php print $offer['phone'] ?></h3>
          </div>
        </div>
      </div>
      <div class="span6 pay-template-content-form2">
        <div class="panel panel-default">
          ...
          <div class="panel-body">
            <h3><i class="fa fa-user"></i>&nbsp&nbsp<b><?php print t('Name');?>:</b>&nbsp<?php print $offer['tourist_name'] ?></h3>
            <h3><i class="fa fa fa-envelope"></i>&nbsp<b><?php print t('E-mail');?>:</b>&nbsp<?php print $offer['tourist_email'] ?></h3>
            <h3>&nbsp<i class="fa fa-mobile"></i>&nbsp&nbsp<b><?php print t('Phone');?>:</b>&nbsp<?php print $offer['tourist_phone'] ?></h3>
          </div>
        </div>
      </div>
    </div>
    <div class="row-fluid pay-template-paddingbot">
